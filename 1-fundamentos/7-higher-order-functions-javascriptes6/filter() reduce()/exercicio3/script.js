...
const getPopulation = () => countries.reduce((acc, population) => acc + population.population, 0);
...
const longestName = (acc, curr) => (acc.name.length > curr.name.length) ? acc : curr;
const findBigger = countries.reduce(longestName);
